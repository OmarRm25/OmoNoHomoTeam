...
<script>
alert('IMPORTANTE: Antes de eliminar el registro asegurese que la información es correcta.');
</script>
...
<input disabled type="text" name="Comentarios" maxlength="35" value="<?php echo $row['Comentarios']; ?>">
 ...
 <br/><br/>
    ...
    <button class="btn red waves-effect waves-light" type="submit" name="action">Eliminar el registro de: <?php echo $row['nombre_usuario'];?>
