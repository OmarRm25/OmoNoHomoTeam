...
<!--formulario para poder actualizar los datos manda el evento-->
 <form action="<?php
               echo 'submit_update_usuario.php'
               ?>
...
<!--Nombre-->
 ...
 <input type="text" name="username" value="<?php echo $row['nombre_usuario']; ?>" maxlength="255" required>
 <br/><br/>
...
<input type="text" name="carrera" value="<?php echo $row['carrera']; ?>" maxlength="255" required>
             <br/><br/></div>
...
<input type="text" name="institucion" maxlength="35" value="<?php echo $row['institucion']; ?>" required>
<br/><br/>
         </div>
...
<input type="text" name="direccion" maxlength="255" required value="<?php echo $row['direcion']; ?>">
             <br/><br/></div>
...
<input type="text" onkeypress="return valida(event) "name="telefono" maxlength="15" value="<?php echo $row['telefono']; ?>" required>
<br/><br/></div>

<div class="col s3">
<!-- Email -->
<label for="correo">Email:</label><br>
<input type="email" name="correo" maxlength="35" required value="<?php echo $row['email']; ?>">
<br/><br/>
</div>
...
<label for="restrcciones">¿Tiene Restricciones?: </label><br>
     ...
     <select   class="browser-default" name="Restriccion">
         
<!--         se maneja el nivel si esta restringido-->
...
<!--manejo del motivo de restriccion y se manda el la DB-->
    
 <?php if($res == 0){
    echo '<input type="text" name="Motivo" maxlength="255" value="No Restringido">';
    
}else{
    
    echo '<input type="text" name="Motivo" maxlength="255" value="'.$row['Motivo'].'">';
}?>
...
<!--manejo del uso de usuarios por tipo de permisos-->
...
<input type="text" name="Comentarios" maxlength="35" value="<?php echo $row['Comentarios']; ?>">
</div>
 ...
 <br/><br/>
    ...
    <button class="btn cyan waves-effect waves-light" type="submit" name="action">Actualizar al usuario: <?php echo $row['nombre_usuario'];?>
