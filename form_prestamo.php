      ...
      <div class="col s8 offset-s2">
        <h5 align="center">Consulta de Cursos Intersemestrales</h5>
          ...
          <!-- Los datos de traen de la consulta -->
            ...
            Carrera:
            <!-- Los datos de traen de la consulta -->
				    <select name="Carreras" method="post" required="required" class="browser-default"
            <?php
            ...
            <table style="width:80%; border:2px">
              ...
              <?php
              $selectOption = $_POST['Carreras'];
              while($row = mysqli_fetch_assoc($conn->query("SELECT * FROM cursos WHERE Carrera = ".$selectOption))){
              ?>
              <tr>
